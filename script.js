...
+++
const BASE_ICON_URL = "https://raw.githubusercontent.com/elitemassagemx/Home/main/ICONOS/";
const BASE_IMAGE_URL = "https://raw.githubusercontent.com/elitemassagemx/Home/main/images/";
...
const services = {
    individual: [
        {
            ...
            duration: "60 min",
            icon: `${BASE_ICON_URL}cfragancia2.png`,
            benefitsIcon: [`${BASE_ICON_URL}cdolor espalda.png`],
            durationIcon: `${BASE_ICON_URL}duration-icon.png`,
        ...
        },
        {
            ...
            duration: "60 min",
            icon: `${BASE_ICON_URL}piedras-calientes-icon.png`,
            benefitsIcon: [`${BASE_ICON_URL}ccirculacion.png`],
            durationIcon: `${BASE_ICON_URL}duration-icon.png`,
        ...
        },
        {
            ...
            duration: "60 min",
            icon: `${BASE_ICON_URL}piedras-frias-icon.png`,
            benefitsIcon: [`${BASE_ICON_URL}cdolor espalda.png`],
            durationIcon: `${BASE_ICON_URL}duration-icon.png`,
        ...
        },
        {
            ...
            duration: "45 min",
            icon: `${BASE_ICON_URL}espalda-cuello-icon.png`,
            benefitsIcon: [`${BASE_ICON_URL}benefits-icon.png`],
            durationIcon: `${BASE_ICON_URL}duration-icon.png`,
        ...
        },
        {
            ...
            duration: "80 min",
            icon: `${BASE_ICON_URL}sueco-relajante-icon.png`,
            benefitsIcon: [`${BASE_ICON_URL}benefits-icon.png`],
            durationIcon: `${BASE_ICON_URL}duration-icon.png`,
        ...
        },
        {
            ...
            duration: "45 min",
            icon: `${BASE_ICON_URL}choco.png`,
            benefitsIcon: [`${BASE_ICON_URL}chidratacion.png`],
            durationIcon: `${BASE_ICON_URL}duration-icon.png`,
        ...
        },
        {
            ...
            duration: "45 min",
            icon: `${BASE_ICON_URL}reflexologia-icon.png`,
            benefitsIcon: [`${BASE_ICON_URL}benefits-icon.png`],
            durationIcon: `${BASE_ICON_URL}duration-icon.png`,
        ...
        },
        {
            ...
            duration: "90 min",
            icon: `${BASE_ICON_URL}envoltura-corporal-icon.png`,
            benefitsIcon: [`${BASE_ICON_URL}benefits-icon.png`],
            durationIcon: `${BASE_ICON_URL}duration-icon.png`,
        ...
        },
        {
            ...
            duration: "60 min",
            icon: `${BASE_ICON_URL}aromas-cera-icon.png`,
            benefitsIcon: [`${BASE_ICON_URL}benefits-icon.png`],
            durationIcon: `${BASE_ICON_URL}duration-icon.png`,
        ...
        },
        {
            ...
            duration: "60 min",
            icon: `${BASE_ICON_URL}lomi-lomi-icon.png`,
            benefitsIcon: [`${BASE_ICON_URL}benefits-icon.png`],
            durationIcon: `${BASE_ICON_URL}duration-icon.png`,
        ...
        },
        {
            ...
            duration: "90 min",
            icon: `${BASE_ICON_URL}shiatsu-icon.png`,
            benefitsIcon: [`${BASE_ICON_URL}benefits-icon.png`],
            durationIcon: `${BASE_ICON_URL}duration-icon.png`,
        ...
        },
        {
            ...
            duration: "60 min",
            icon: `${BASE_ICON_URL}cbd-icon.png`,
            benefitsIcon: [`${BASE_ICON_URL}benefits-icon.png`],
            durationIcon: `${BASE_ICON_URL}duration-icon.png`,
        ...
        },
        {
            ...
            duration: "90 min",
            icon: `${BASE_ICON_URL}ventosas-icon.png`,
            benefitsIcon: [`${BASE_ICON_URL}benefits-icon.png`],
            durationIcon: `${BASE_ICON_URL}duration-icon.png`,
    ...
    pareja: [
        ...
        },
        {
            ...
            duration: "45 min",
            icon: `${BASE_ICON_URL}cuello-espalda-icon.png`,
            benefitsIcon: [`${BASE_ICON_URL}benefits-icon.png`],
            durationIcon: `${BASE_ICON_URL}duration-icon.png`,
        ...
        },
        {
            ...
            duration: "45 min",
            icon: `${BASE_ICON_URL}chocolaterapia-icon.png`,
            benefitsIcon: [`${BASE_ICON_URL}benefits-icon.png`],
            durationIcon: `${BASE_ICON_URL}duration-icon.png`,
            image: `${BASE_IMAGE_URL}chocolaterapia-image.jpg`,
    ...
    paquetes: [
        {
            ...
            icon: `${BASE_ICON_URL}romance-total-icon.png`,
            benefitsIcon: [`${BASE_ICON_URL}benefit1-icon.png`, `${BASE_ICON_URL}benefit2-icon.png`],
            durationIcon: `${BASE_ICON_URL}duration-romance-icon.png`,
        ...
        },
        {
            ...
            duration: "90 minutos de masaje + 30 minutos para disfrutar de las delicias.",
            benefits: ["Relajación profunda", "experiencia sensorial completa", "momentos de disfrute compartido"],
            icon: `${BASE_ICON_URL}romance-total2-icon.png`,
            benefitsIcon: [`${BASE_ICON_URL}benefit1-icon.png`, `${BASE_ICON_URL}benefit2-icon.png`],
            durationIcon: `${BASE_ICON_URL}duration-romance2-icon.png`,
        ...
        },
        {
            ...
            icon: `${BASE_ICON_URL}lujo-sabor-icon.png`,
            benefitsIcon: [`${BASE_ICON_URL}benefit-lujo1-icon.png`, `${BASE_ICON_URL}benefit-lujo2-icon.png`],
            durationIcon: `${BASE_ICON_URL}duration-lujo-icon.png`,
        ...
        },
        {
            ...
            icon: `${BASE_ICON_URL}sensaciones-icon.png`,
            benefitsIcon: [`${BASE_ICON_URL}benefit-sensaciones1-icon.png`, `${BASE_ICON_URL}benefit-sensaciones2-icon.png`],
            durationIcon: `${BASE_ICON_URL}duration-sensaciones-icon.png`,
        ...
        },
        {
            ...
            icon: `${BASE_ICON_URL}escape-lujo-icon.png`,
            benefitsIcon: [`${BASE_ICON_URL}benefit-escape1-icon.png`, `${BASE_ICON_URL}benefit-escape2-icon.png`],
            durationIcon: `${BASE_ICON_URL}duration-escape-icon.png`,
        ...
        },
        {
            ...
            icon: `${BASE_ICON_URL}relax-sabores-icon.png`,
            benefitsIcon: [`${BASE_ICON_URL}benefit-relax1-icon.png`, `${BASE_ICON_URL}benefit-relax2-icon.png`],
            durationIcon: `${BASE_ICON_URL}duration-relax-icon.png`,
        ...
        },
        {
            ...
            icon: `${BASE_ICON_URL}tranquilidad-gourmet-icon.png`,
            benefitsIcon: [`${BASE_ICON_URL}benefit-tranquilidad1-icon.png`, `${BASE_ICON_URL}benefit-tranquilidad2-icon.png`],
            durationIcon: `${BASE_ICON_URL}duration-tranquilidad-icon.png`,
        ...
        },
        {
            ...
            icon: `${BASE_ICON_URL}relajacion-gourmet-icon.png`,
            benefitsIcon: [`${BASE_ICON_URL}benefit-relajacion1-icon.png`, `${BASE_ICON_URL}benefit-relajacion2-icon.png`],
            durationIcon: `${BASE_ICON_URL}duration-relajacion-icon.png`,
            image: `${BASE_IMAGE_URL}copas.jpg`,
    ...
    // Agregar evento de scroll suave a los enlaces de navegación
    ...
    // Función para actualizar la navegación activa durante el scroll
    function updateActiveNavigation() {
        ...
        document.querySelectorAll('section').forEach(section => {
            ...
            if (scrollPosition >= sectionTop - 50 && scrollPosition < sectionTop + sectionHeight - 50) {
                const correspondingNavItem = document.querySelector(`.main-nav a[href="#${section.id}"]`);
    ...
    // Agregar evento de scroll para actualizar la navegación activa
