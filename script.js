...
const services = {
    ...
    function renderServices(category) {
        ...
        services[category].forEach(service => {
            ...
            setAttributes(serviceElement.querySelector('.service-icon'), {
                src: service.icon,
                alt: `${service.title} icon`
            });
            serviceElement.querySelector('.service-description').textContent = service.description;
            setAttributes(serviceElement.querySelector('.benefits-icon'), {
                src: Array.isArray(service.benefitsIcon) ? service.benefitsIcon[0] : service.benefitsIcon,
                alt: 'Beneficios'
            });
            serviceElement.querySelector('.service-benefits').textContent = service.benefits.join(', ');
            setAttributes(serviceElement.querySelector('.duration-icon'), {
...
function renderPackages() {
        ...
        services.paquetes.forEach(pkg => {
            const packageElement = createElementFromHTML(`
