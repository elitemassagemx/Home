document.addEventListener('DOMContentLoaded', () => {
    // Función para generar las tarjetas de masajes
    function generarTarjetasMasajes() {
      const contenedor = document.querySelector('.massage-types');
      ...
      masajes.forEach(masaje => {
        ...
        tarjeta.innerHTML = 
          <div class="card-content">
            ...
            <p><strong>Beneficios:</strong> ${masaje.beneficios}</p>
            <p><strong>Duración:</strong> ${masaje.duracion}</p>
            <button class="btn" onclick="abrirModalReserva('${masaje.nombre}')">Reservar Ahora</button>
          </div>
        ;
        contenedor.appendChild(tarjeta);
      });
    }
    // Función para generar las tarjetas de paquetes
    function generarTarjetasPaquetes() {
      const contenedor = document.querySelector('.packages');
      paquetes.forEach(paquete => {
        ...
        tarjeta.innerHTML = 
          <div class="card-content">
            ...
            <p><strong>Incluye:</strong> ${paquete.incluye}</p>
            <p><strong>Duración:</strong> ${paquete.duracion}</p>
            <button class="btn" onclick="abrirModalReserva('${paquete.nombre}')">Reservar Ahora</button>
          </div>
        ;
        contenedor.appendChild(tarjeta);
      });
    ...
    function abrirModalReserva(servicio) {
      ...
      // Aquí puedes agregar lógica para pre-llenar el formulario con el servicio seleccionado
    }
    ...
    function manejarEnvioReserva(event) {
      ...
      si si , eso en donde devo ponerlo en js o css o html
    const services = {
        individual: [
